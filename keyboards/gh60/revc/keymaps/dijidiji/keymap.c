...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_60_ansi_tsangan(
    ...
    _______, KC_HOME, KC_UP,   KC_END,  KC_PGUP, _______, _______, _______, _______, _______, _______, _______, _______, KC_PSCR,
    ...
    _______, _______, _______,                   _______,                                              _______, _______, MO(3)
  ),
  /* 3: Bootloader and qwerty/colemak swap */
  [3] = LAYOUT_60_ansi_tsangan(
    RESET,   DF(0),   DF(1),   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
